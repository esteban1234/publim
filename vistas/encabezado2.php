...
<head>
	<meta charset="UTF-8">
	<meta name="google-site-verification" content="GvtfP0ouZtcNbFXdLqwXkDYqqPsBn4tJomH3d9rl0ZU" />
	<link rel="icon" type="image/png" href="../img/favicon.png" />
	<title>PUBLICIDAD CREATIVA INTEGRAL PUBLIM</title>
	 <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
  	<META NAME="Title" content="PUBLICIDAD CREATIVA INTEGRAL PUBLIM">
  	<META NAME="Author" CONTENT="[http://creativospublim.com/]"/>
